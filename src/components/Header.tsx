...
export default function Header() {
  ...
  return (
    <div className="relative w-full z-50">
      <header
        className='relative bg-[url(/fondoB.jpg)] text-white px-6 md:px-10 py-8 w-full flex justify-center items-center transition-all duration-500 ease-in-out flex-col gap-6 h-[260px]'
      >
        <img src="/logo_w.png" alt="logo" className="absolute opacity-10 w-[80%] z-10 bg-cover h-full z-10" />
        <Link href="/">
          <img src="/logo_w.png" alt="Logo" className="relative object-cover h-20 z-20" />
        </Link>
