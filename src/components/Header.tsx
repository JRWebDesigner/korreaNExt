...
export default function Header() {
  ...
  return (
    <div className="relative w-full z-50">
      <header className="relative bg-[url(/fondoB.jpg)] bg-cover bg-center text-white px-6 md:px-10 py-32 w-full flex justify-center items-center flex-col gap-3 min-h-[130px] md:min-h-[200px]">
