...
export default function Footer(){
  return(
        <footer className="relative z-50 bg-black text-white py-16 px-6 md:px-20 flex flex-col items-center justify-center w-full">
      ...
      <div className="w-full flex flex-wrap justify-center gap-6  pt-6 text-xl">
